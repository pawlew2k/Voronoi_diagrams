...
class BeachLine:
    ...
    def transplant(self, node_u, node_v):
        """
        zamienia nody u na node v
        :param node_u: zamieniany node
        :param node_v: node, na który zmieniamy
        """
    ...
    def minimum(self, node):
        """
        metoda znajduje node o najmniejszym kluczu w drzewie (poddrzewie) w którym korzeniem jest node (parametr)
        :param node:
        :return: minimalny node
        """
        temp_node = node
    ...
    def maximum(self, node):
        """
        metoda znajduje node o największymkluczu w drzewie (poddrzewie) w którym korzeniem jest node (parametr)
        :param node:
        :return: maksymalny node
        """
        temp_node = node
